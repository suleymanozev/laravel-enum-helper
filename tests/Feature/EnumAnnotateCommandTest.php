...
it('can be success single file', function () {
    $this->artisan("enum:annotate --folder={$this->withoutDocBlockEnumsFolder} Suleymanozev\\\\LaravelEnumHelper\\\\Tests\\\\Support\\\\WithoutDocBlockEnums\\\\StatusWithoutDocBlock")
        ->assertSuccessful();
...
it('can be success single file with exists doc block', function () {
    $this->artisan("enum:annotate --folder={$this->enumsFolder} Suleymanozev\\\\LaravelEnumHelper\\\\Tests\\\\Support\\\\Enums\\\\Status")
        ->assertSuccessful();
...
it('can be success single file with exists doc block without method tags', function () {
    ...
    $this->artisan("enum:annotate --folder={$this->withoutDocBlockEnumsFolder} Suleymanozev\\\\LaravelEnumHelper\\\\Tests\\\\Support\\\\WithoutDocBlockEnums\\\\StatusWithoutMethodTagDocBlock")
        ->assertSuccessful();
...
it('can be failed with class', function () {
    $this->artisan('enum:annotate Suleymanozev\\\\LaravelEnumHelper\\\\Tests\\\\Support\\\\NotEnums\\\\TestClass')
        ->assertFailed();
});
